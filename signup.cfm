...
#application.snip.errormsg()#
	...
	<div id="header-block">
		...
		<h2>New #application.snip.account_title2#</h2></div>
	</div><!-- header block -->

	<div id="main-block"><form method="post"><p>Please create a password.</p>
		<div class="row">
		...
		<div class="row">
			...
			<input type="password" value="" name="password2" id="password2" placeholder="Password again" />
		</div><!-- row -->
		<div class="row">
			<div class="col"><button class="blue button" type="submit">Sign&##160;Up</button></div>
	...
	<div id="section-c">
#application.snip.loginbuttons("Sign&##160;up")#
	</div><!-- section-c -->
